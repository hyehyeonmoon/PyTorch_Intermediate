...
class MyEngine(Engine):
    ...
    def train(engine, mini_batch):
        ...
        if isinstance(y, torch.LongTensor) or isinstance(y, torch.cuda.LongTensor): #longtensor일 경우 classification, 아닐 경우 regression
    ...
    def attach(train_engine, validation_engine, verbose=VERBOSE_BATCH_WISE):
        ...
        # 전 코드에서는 1 epoch 동안의 iteration의 모든 loss들을 일일이 더하고 나누어 주었다면,
        # attach_running_average를 통해 한 번에 계산할 수 있음
